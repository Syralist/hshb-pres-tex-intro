...
\begin{frame}[fragile] %%Eine Folie
	...
	\column{.67\textwidth}
		\begin{itemize}
			...
			\begin{itemize}
				\item article \\(Aufsätze, wenige Abschnitte)\pause
				\item report \\(Berichte, mehrere Kapitel)\pause
...
\divider{\insertsubsection}
\begin{frame}[fragile] %%Eine Folie
	\frametitle{Quellcode} %%Folientitel
	\begin{lstlisting}
	\usepackage{listings}
	\lstset{language=[LaTeX]TeX,
	escapeinside=||,
	frame=single,
	backgroundcolor=\color{Cornsilk}}|\pause|
	
	\begin{lstlisting}
	\usepackage{listings}
	...Quellcode steht hier...
	\end|\{|lstlisting}
	\end{lstlisting}
\end{frame}
